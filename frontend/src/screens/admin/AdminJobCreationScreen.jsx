...
const AdminJobCreationScreen = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast.error(`İlan oluşturulurken hata oluştu: ${err.data?.message || 'Bilinmeyen hata'}`);
    }
  };
              ...
              <Form onSubmit={handleSubmit}>
                ...
                <div className='d-flex justify-content-end gap-2 mt-4'>
                  ...
                  >
                    {isCreating ? (
                      <>
                        <Spinner as='span' animation='border' size='sm' className='me-2' variant='success'/>
                        Oluşturuluyor...
                      </>
                    ) : (
                      'İlanı Oluştur'
...
export default AdminJobCreationScreen;