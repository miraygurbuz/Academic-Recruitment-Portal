              ...
              {['D1', 'D2', 'D3', 'D4', 'D5', 'D6'].map((category, idx) => (
                <React.Fragment key={category}>
                  <tr>
                    <td colSpan='4' style={{...styles.cellStyle, fontWeight: 'bold'}}>
                      {idx + 1}) {
                        category === 'D1' ? 'SCI, SCI-E, SSCI ve AHCI tarafından taranan dergilerde yayımlanmış ve adayın yazar olarak yer almadığı makalelerde adayın yayınlarına yapılan atıf' :
                        category === 'D2' ? 'SCI, SCI-E, SSCI ve AHCI dışındaki uluslararası indekslerde taranan dergilerde yayımlanmış ve adayın yazar olarak yer almadığı makalelerde adayın yayınlarına yapılan atıf' :
                        category === 'D3' ? 'Ulusal hakemli dergilerde yayımlanmış ve adayın yazar olarak yer almadığı makalelerde adayın yayınlarına yapılan atıf' :
                        category === 'D4' ? 'Uluslararası yayınevleri tarafından yayımlanan ve adayın yazar olarak yer almadığı kitaplarda adayın yayınlarına yapılan atıf' :
                        category === 'D5' ? 'Ulusal yayınevleri tarafından yayımlanan ve adayın yazar olarak yer almadığı kitaplarda adayın yayınlarına yapılan atıf' :
                        'Adayın ismine SCI, SCI-E, SSCI ve AHCI tarafından taranan dergilerde atıf yapılmaksızın adayın çalışmalarından bahsedilmesi veya adaya teşekkür edilmesi'
                      }
                    </td>
                  </tr>
                  ...
                  <tr>
                    <td colSpan='4' style={{...styles.cellStyle, fontWeight: 'bold'}}>
                      {idx + 1}) {
                        ...
                        category === 'F3' ? 'Doktora/Sanatta Yeterlilik Eş Danışmanlığı' :
                        'Yüksek Lisans Eş Danışmanlığı'
                      }
                    </td>
                  </tr>
